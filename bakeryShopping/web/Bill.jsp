                                    ...
                                    <div class="col-md-4">
                                        <div >
                                            ...
                                            <form action="Purchase">
                                                ...
                                                <c:if test="${fail}">
                                                    <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal1" href="#" class="btn btn-danger" style="width : 100%; margin-top: 5px;">Xác nhận đơn hàng</button>
                                                </c:if>
                                                <c:if test="${!fail}">
                                                    <button type="submit" class="btn btn-danger" style="width : 100%; margin-top: 5px;">Xác nhận đơn hàng</button>
                                                </c:if>
                                                <div >
                                                    <a href="Cart.jsp" class="btn btn-success" style="width : 100%; margin-top: 5px;">Về giỏ hàng</a>
                                                </div>
                                            </form>
...
//        let provinceSelect = document.getElementById("provinceSelect");
    ...
    function fetchShippingFee() {
        ...
        fetch("https://online-gateway.ghn.vn/shiip/public-api/v2/shipping-order/fee?service_type_id=2&insurance_value=0&coupon=&from_district_id=1542&to_district_id=" + districtId + "&to_ward_code=" + wardId + "&height=" + 1+ "&length=" + 1 + "&weight=" + 1 + "&width=" + 1, {
            method: 'GET',
            headers: {
                'token': 'beeffb36-e516-11eb-9cee-6e1c80ec1bcb'
            }
